# KeisPlay for Windows

KeisPlay is an independent Windows client designed for TVTeam users. It combines live television, the programme guide and catch-up viewing in a modern interface built for keyboard, mouse and multi-monitor use.

## Features

- Live TV with a responsive channel list and keyboard shortcuts
...
[Download the latest stable MSI installer](https://github.com/kkeisyr11/KeisPlay-Releases/releases/latest)

KeisPlay requires 64-bit Windows 11 and an active TVTeam account. The application does not include or sell access to television channels.
